// ignore_for_file: unused_field, prefer_const_constructors, avoid_print, use_key_in_widget_constructors, must_be_immutable, unused_element, unused_local_variable, avoid_unnecessary_containers
    ...
    class _EditState extends State<Edit> {
      ...
      Future _getData() async {
        try {
          final response = await http.get(Uri.parse(
              ...
              "http://192.168.1.2/flutter_jfw/detail.php?id='${widget.id}'"));
          ...
          if (response.statusCode == 200) {
            ...
            setState(() {
              ...
              descr     = TextEditingController(text: data['descr']);              
              gambar    = TextEditingController(text: data['gambar']);
              linknews  = TextEditingController(text: data['linknews']);
            });
          }
        } catch (e) {
          print(e);
      ...
      Future _onUpdate(context) async {
        try {
          return await http.post(
            Uri.parse("http://192.168.1.2/flutter_jfw/update.php"),
            body: {
              "id"        : widget.id,
              "title"     : title.text,
              "descr"     : descr.text,
      ...
      Future _onDelete(context) async {
        try {
          return await http.post(
            Uri.parse("http://192.168.1.2/flutter_jfw/delete.php"),
            body: {
              "id": widget.id,
            },
          ).then((value) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    maxLines: null,
                    decoration: InputDecoration(
                        hintText: 'Kosongkan kalau tidak yakin',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(15.0),
                        ),
                        fillColor: Colors.white,
